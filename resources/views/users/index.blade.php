...
<div class=container>
    <div class=row>
        <div class="list-group col-md-4">
            ...
            <script
                src="https://maps.googleapis.com/maps/api/js?key={{ config('services.google-map.apikey') }}&callback=initMap"
                async defer></script>
        ...
        <div class="column col-md-8">
            <div style="margin-top:50px;">
                ...
                <div class="d-inline-flex col-md-6">
                    ...
                    <a class="btn btn-primary" href={!! route('users.CsvDownload') !!}>CSV出力</a>
                </div>
